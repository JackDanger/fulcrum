...
pub struct ScoreArgs {
    ...
    pub rg: PathBuf,
    /// Box name, e.g. `"neurotic"`
    pub box_name: String,
    /// Freeze method description, e.g. `"/root/bench-lock.sh"`
...
pub fn usage_score() -> &'static str {
    "fulcrum score \\\n\
     ...
     \x20\x20--box <name>                # e.g. neurotic\n\
     \x20\x20--freeze-method <str>       # e.g. \"/root/bench-lock.sh\"\n\
...
mod tests {
    ...
    fn test_args() -> ScoreArgs {
        ScoreArgs {
            ...
            corpus: "silesia".into(),
            corpus_path: PathBuf::from("/root/silesia.gz"),
            ...
            native: PathBuf::from("/root/gzippy-native"),
            isal: PathBuf::from("/root/gzippy-isal"),
            rg: PathBuf::from("/root/oracle_c/rapidgzip-native"),
            box_name: "neurotic".into(),
            freeze_method: "/root/bench-lock.sh".into(),
